...
class videoController extends Controller{ 
    ...
    public function watchVideo(Request $request) {
       ...
       // Llistar totes les series
    public function allSeries() {
        $series = Video::byTipo('serie')->get();
        return new VideoCollection($series);
    }

    // Llistar totes les pelicules
    public function allMovies() {
        $movies = Video::byTipo('movie')->get();
        return new VideoCollection($movies);
    }
    
    // Search videos per titol (amb like)
    public function videosByTitle($title) {
        $videos = Video::byTitle($title)->get();
        return new VideoCollection($videos);
    }

    // By Id
    public function videosById($id) {
        $videos = Video::byId($id)->get();
        return new VideoCollection($videos);
    }

    // Buscar videos per genere
    public function videosByGenere($genere) {
